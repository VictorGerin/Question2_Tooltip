...
it('renders element in content', () => {
    ...
    const elementContent = <div><span>Teste</span></div>
...
it("renders tooltip opended", () => {
    ...
    expect(() => getByTestId('content')).toThrowError('Unable to find an element by: [data-testid="content"]')
...
it('Change direction on screen overlap (left to right)', () => {
    const {getByTestId} = render(
        <div style={{display: 'flex', alignItems: 'center', width:1024, height:768}}>
            <Tooltip content='Ola mundo' direction='left' width={70} open>
            <div style={{backgroundColor:'#ccc', width:100, height:100, alignItems: 'center'}}>
    ...
    getByTestId('content').getBoundingClientRect = () => {
        return {
            bottom: 434, height: 100, left: 0, right: 100, top: 334, width: 100, x: 0, y: 334
        }
    }
...
it('Change direction on screen overlap (right to left)', () => {
    ...
    getByTestId('content').getBoundingClientRect = () => {
        return {
            "x": 842, "y": 371, "width": 82, "height": 26, "top": 371, "right": 924, "bottom": 397, "left": 842
        }
    }

    getByTestId('Tooltip-Wrapper').getBoundingClientRect = () => {
        return {
            "x": 924, "y": 334, "width": 100, "height": 100, "top": 334, "right": 1024, "bottom": 434, "left": 924
        }
    }
...
it('Change direction on screen overlap (top to bottom)', () => {
    const {getByTestId} = render(
        <div style={{display: 'flex', flexDirection: 'column' , alignItems: 'center', width:1024, height:768}}>
    ...
    getByTestId('content').getBoundingClientRect = () => {
        return {
            "x": 484.59375, "y": 100, "width": 77.40625, "height": 40, "top": 100, "right": 562, "bottom": 140, "left": 484.59375
        }
    }

    getByTestId('Tooltip-Wrapper').getBoundingClientRect = () => {
        return {
            "x": 462, "y": 0, "width": 100, "height": 100, "top": 0, "right": 562, "bottom": 100, "left": 462
        }
    }
...
it('Change direction on screen overlap (bottom to top)', () => {
    const {getByTestId} = render(
        <div style={{display: 'flex', flexDirection: 'column-reverse' , alignItems: 'center', width:1024, height:768}}>
    ...
    getByTestId('content').getBoundingClientRect = () => {
        return {
            "x": 471, "y": 642, "width": 82, "height": 26, "top": 642, "right": 553, "bottom": 668, "left": 471
        }
    }

    getByTestId('Tooltip-Wrapper').getBoundingClientRect = () => {
        return {
            "x": 462, "y": 668, "width": 100, "height": 100, "top": 668, "right": 562, "bottom": 768, "left": 462
        }
    }
...
it('Not change direction on screen overlap (bottom to top)', () => {
    const {getByTestId} = render(
        <div style={{display: 'flex', flexDirection: 'column-reverse' , alignItems: 'center', width:1024, height:768}}>
          <Tooltip content='Ola mundo' direction='bottom' width={70} dissableAutoChangeDirection open>
            <div style={{backgroundColor:'#ccc', width:100, height:100}}>
              <span style={{color:'white'}}>Teste</span>
            </div>
          </Tooltip>
